...
if (isset($content_topic) && $content_topic > 0) {
    ...
    if (xoops_getModuleOption('disp_option', $forMods->getVar('dirname'))
        && '0' == $view_topic->getVar('topic_showpdf')) {
        redirect_header('index.php', 3, _NOPERM);
        exit;
    }

    if ('0' == xoops_getModuleOption('disp_pdflink', $forMods->getVar('dirname'))) {
        redirect_header('index.php', 3, _NOPERM);
        exit;
    }
}
...
//Date / Author display
if (isset($content_topic) && $content_topic > 0 && '0' != $view_topic->getVar('topic_showtype')) {
