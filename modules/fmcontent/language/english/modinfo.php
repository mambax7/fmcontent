...
if (!defined('_MI_FMCONTENT_NAME')) {
    ...
    define(
        ...
        'Select the URL rewrite mode you want to use.<ul>
    ...
    define('_FMCONTENT_IMAGE_WIDTH_DESC', 'Max allowed width for images in content listed in index/topic pages<br> A max width/height for images in content pages is set in /assets/css/style.css');
    ...
    //1.11
    //Help
    define('_MI_FMCONTENT_DIRNAME', basename(dirname(__DIR__, 2)));
    define('_MI_FMCONTENT_HELP_HEADER', __DIR__ . '/help/helpheader.tpl');
    define('_MI_FMCONTENT_BACK_2_ADMIN', 'Back to Administration of ');
    define('_MI_FMCONTENT_OVERVIEW', 'Overview');

    //define('_MI_FMCONTENT_HELP_DIR', __DIR__);

    //help multi-page
    define('_MI_FMCONTENT_DISCLAIMER', 'Disclaimer');
    define('_MI_FMCONTENT_LICENSE', 'License');
    define('_MI_FMCONTENT_SUPPORT', 'Support');
}
