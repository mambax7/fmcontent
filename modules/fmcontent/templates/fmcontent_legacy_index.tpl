...
<div class="fmcontent">
    <{if $type == 'type1' || $type == 'type3'}>
        ...
        <{if $default}>
            <div id="default" class="item">
                ...
                <{/if}>
                <div class="itemPostDate"><{$smarty.const._FMCONTENT_DATE}>: <{$default.content_create}>
                    <{if $xoops_isadmin}>
        ...
        <{if $showtype == 1 && ($content_limit != 0 || !$content_topic)}>
            ...
            <{$smarty.const._FMCONTENT_DATE}>
                                : <{$content.content_create}><{if $content.content_update != $content.content_create}> &bull; <{$smarty.const._FMCONTENT_UPDATE}>: <{$content.content_update}><{/if}>
            </span>
    ...
    <{if $type == 'type4'}>
        ...
        <div id="default" class="item">
                ...
                <div class="itemShort">
                    <{if $contents.content_img}>
                        <div class="itemImg gallery">
                            ...
                            <{else}>
                                <img width="<{$imgwidth}>" class="<{$imgfloat}> content_img" src="<{$contents.imgurl}>"
            ...
            <{/if}>
            <div class="itemPostDate"><{$smarty.const._FMCONTENT_DATE}>: <{$contents.content_create}>
                <{if $xoops_isadmin}>
                    <span class="itemAdminLink">
