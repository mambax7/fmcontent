...
<div class="fmcontent">
    <{if $content_error}>
        ...
        <div class="ui-state-error"><{$content_error}></div>
    <{else}>
        <div class="ui-widget-content ui-corner-all">
            ...
            <div class="ui-widget-content ui-corner-all">
                <{if $content.content_short}>
                    <div class="ui-state-default ui-corner-all"><{$content.content_short}></div>
                <{/if}>
                <{if $advertisement && $content.content_short}>
                    <div class="itemAde"><{$advertisement}></div>
                <{/if}>
                <div class="editable <{$multiple_columns}>" id="content_<{$content.content_id}>">
                ...
                <{if $link.date}>
                    <{if $content.content_update != $content.content_create}>
                        <div class="itemPostDate"><{$smarty.const._FMCONTENT_UPDATE}>: <{$content.content_update}></div>
                    <{/if}>
                <{/if}>
            ...
            <div class="ui-state-default ui-corner-all">
                <div class="floatleft">
                    ...
                    <{if $content.content_comments > 1}><a href="#comm"
                        ...
                        <a href="#comm"
                           title="<{$smarty.const._FMCONTENT_COM}>"><{$content.content_comments}> <{$smarty.const._FMCONTENT_COM}></a><{/if}>
                </span>
                ...
                <{if $link.prev || $link.next}>
                    <div class="floatright">
                        <{if $link.prev}>
                            <span class="floatright"><a href="<{$link.prev}>"
                        ...
                        <{/if}>
                        <{if $link.next}>
                            <span class="floatleft"><a href="<{$link.next}>"
