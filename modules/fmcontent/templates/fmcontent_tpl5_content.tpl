        ...
        <article class="item">
            <header>
                ...
                <div class="itemInfo">
                    ...
                    <{/if}>
                    <{if $link.date}>
                        <span class="itemPostDate"><{$smarty.const._FMCONTENT_DATE}>:  <time
                                    datetime="<{$content.content_create}>"
                                    pubdate><{$content.content_create}></time></span>
                            ...
                            <div class="gallery">
                                <{if $img_lightbox}>
                                    <a href="<{$content.imgurl}>" title="<{$content.content_title}>">
                                        <img class="content_img" src="<{$content.imgurl}>"
                    ...
                    <{if $link.date}>
                        <{if $content.content_update != $content.content_create}>
                            <div class="itemPostDate"><{$smarty.const._FMCONTENT_UPDATE}>:
                                <time datetime="<{$content.content_update}>"><{$content.content_update}></time>
                            </div>
                        <{/if}>
                    <{/if}>
                </div>
